...
abstract class AppLocalizations {
  ...
  /// No description provided for @notes_colors.
  ///
  /// In en, this message translates to:
  /// **'Notes Colors'**
  String get notes_colors;

  /// No description provided for @choose_color_for_note.
  ///
  /// In en, this message translates to:
  /// **'Choose color for note'**
  String get choose_color_for_note;
  ...
  /// No description provided for @reset_colors.
  ///
  /// In en, this message translates to:
  /// **'Reset colors?'**
  String get reset_colors;

  /// No description provided for @are_you_sure_you_want_to_reset_the_colors_of_the_notes.
  ///
  /// In en, this message translates to:
